...
6. Ports 1337, 1338, 27000 available on host machine (for Mantis dashboard and MongoDB)
...
2. Delete Mantis, Appsmith and don't delete MongoDB${BYellow}
    - Recommended to export the dashboard before deleting Appsmith${BICyan}
3. Delete Mantis, MongoDB and don't delete Appsmith${BYellow}
